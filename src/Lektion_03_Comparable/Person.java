    ...
    public int compareTo(Person o) {
        ...
        if (this.lName.compareTo(o.lName) > 0) {
            ...
            if (this.fName.compareTo(o.fName) > 0) {
                ...
                if (this.birthDay.compareTo(o.birthDay) > 0) {
                    return 1;
                } else if (this.birthDay.compareTo(o.birthDay) < 0) {
                    return -1;
                } else {
                    return 0;
                }
    ...
    public static void main(String[] args) {
        ...
        Comparator<Person> comp = new Comparator<Person>() {
            ...
            public int compare(Person o1, Person o2) {
                double o1Heigth = o1.heigth;
                double o2Heigth = o2.heigth;
                if (o1Heigth < o2Heigth)
                    return -1 ;
                else if (o1Heigth == o2Heigth)
                    return 0;
                else 
                    return 1;
            }
